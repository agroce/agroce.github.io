...
\item {\bf Summary:} I have over fifteen years of experience in
  ...
  Workbench (NC), and TSTL.  Recently I have been developing languages
  and systems tools for software testing and secure code development.
  ...
  formal methods venues, with over 3,300 citations, an h-index of 30,
  and an i10-index of 58, according to Google Scholar.  I served on
  the program committees for ICSE, ASE, and ISSTA multiple times in
  recent years, and write a regular column for ACM SIGSOFT Software
  Engineering Notes.  I make 500-1,000 GitHub commits in a typical
...
accepted for presentation, September-October 2018 (tutorials track,
acceptance rate 55\%).
...
\newblock \emph{ACM/IEEE International Conference on Software Engineering}, accepted for publication, Gotherburg, Sweden, May-June 2018 (demonstrations track).
