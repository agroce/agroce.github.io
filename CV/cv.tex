...
\item {\bf Summary:} I have over fifteen years of experience in
  ...
  formal methods venues, with over 3,400 citations, an h-index of 30,
...
\newblock \emph{Automated Software Engineering Journal}, accepted for publication.
...
accepted for publication and presentation, September-October 2018 (tutorials track, 
acceptance rate 55\%). 

\item Arpit Christ and {\bf Alex Groce}.
...
\newblock \emph{IEEE International Conference on Software Quality,
  Reliability, and Security}, accepted for publication, July 2018,
Lisbon, Portugal (acceptance rate 19\%).
...
\newblock \emph{ACM/IEEE International Conference on Software Engineering}, accepted for publication, Gothenburg, Sweden, May-June 2018 (demonstrations track).
...
\begin{Professional Activities and Service}
  ...
  (STVR), \emph{Automated Software Engineering Journal}, \emph{Annals
    ...
    of Computer Programming}, \emph{Journal of Applied Logic} (JAL),
