...
\item {\bf Summary:} I have over fifteen years of experience in
  ...
  and an i10-index of 60, according to Google Scholar.  I served on
...
\item \emph{Designing}, \emph{specifying}, \emph{coding},
  ...
  and more generally, all layers of modern computer system environments, from system libraries to user applications.
...
\newblock \emph{IEEE Cybersecurity Development Conference (SecDev)}, Boston, Massachusetts, September-October 2018 (tutorials track, 
acceptance rate 55\%). 
