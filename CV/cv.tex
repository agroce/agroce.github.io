...
\item {\bf Summary:} I have over fifteen years of experience in
  ...
  formal methods venues, with over 3,500 citations, an h-index of 30,
...
\newblock \emph{IEEE International Symposium on Software Reliability 
  Engineering}, accepted for publication, Memphis, Tennessee, October 
2018 (acceptance rate 24\%).
...
accepted for publication, Memphis, Tennessee, October  2018.
...
accepted for publication and presentation, Boston, Massachusetts, September-October 2018 (tutorials track, 
acceptance rate 55\%). 
...
\item Program committee $\cdot$ Second ACM International Workshop on
