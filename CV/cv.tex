...
\newcategory{Books, Chapters, Edited Volumes}
...
\item {\bf Summary:} I have over twenty years of experience in
  ...
  Workbench (NC), DeepState, Slither, Echidna, the Universal Mutator, and TSTL.  Recently I have been developing languages
  and systems tools to make software testing and development of reliable and secure
  ...
  formal methods venues, with over 9,100 citations, an h-index of 45,
  and an i10-index of 101, according to Google Scholar.  I served on
  the program committees for ICSE, ASE, FSE, and ISSTA multiple times in
  recent years, write a regular column for ACM SIGSOFT Software
  Engineering Notes, and serve on the editorial boards of IEEE Software and Software: Testing, Verification and
   Reliability.  I make 500-1,000 GitHub commits in a typical
...
\item {\bf 8/2019--6/2023 $\cdot$ Consulting Security Engineer, Trail of Bits:} Continued exploring novel smart contract analysis methods and tools, surveyed sources of smart contract flaws in high value contracts, and potential for various automated vulnerability discovery approaches. 
...
\item \emph{Designing}, \emph{specifying}, \emph{coding},
  ...
  education.  In a larger sense, my primary concern is what I think of
  as \emph{applied epistemology}, a question perhaps even more central
  in the age of language-model based code synthesis: how do we know
  that a computer system does what we want it to do?  How do we even know
...
\item {\bf Alex Groce}.
  \newblock Scholars and Innovators in Modern Programming: Conversations About Software Engineering.
  \newblock Apress, 2026 (forthcoming).
...
\newblock \emph{Journal of Software Testing, Verification and
  Reliability}, 26(1): 40-68, January 2016.
...
\begin{Refereed Conference and Workshop Publications}
 ...
 \item 
{\bf Alex Groce}. 
\newblock (This is Not a Paper About) Mutation Driven Development. 
\newblock \emph{ACM Symposium on New Ideas in Programming and 
  ...
  Software for Humanity)}, accepted for  publication, Oakland, California, October 2026.
  
 \item 
{\bf Alex Groce}. 
\newblock (Programs), Proofs and Refutations (and Tests and Mutants). 
\newblock \emph{ACM Symposium on New Ideas in Programming and 
  Reflections on Software, Onward! Essays, part of SPLASH (ACM SIGPLAN 
  Conference on Systems, Programming, Languages and Applications: 
  Software for Humanity)}, pages 223-230, Pasadena, California, October 2024.
...
see above for journal publication information, Porto de Galinhas, Brazil, July 2024.
...
\item{\bf Alex Groce}.
  \newblock John Ruskin's \emph{The Elements of Drawing}. 
  \newblock Passages column, \emph{ACM SIGSOFT Software Engineering 
  Notes}, accepted for publication.  

\item{\bf Alex Groce}.
  \newblock Donald E. Knuth's \emph{Literate Programming}. 
  \newblock Passages column, \emph{ACM SIGSOFT Software Engineering 
  Notes}, accepted for publication.  
  
\item{\bf Alex Groce}. 
  \newblock Richard P. Gabriel's \emph{Patterns of Software}. 
  \newblock Passages column, \emph{ACM SIGSOFT Software Engineering 
  Notes}, 51(3): 7-8, July 2026.  
  
\item{\bf Alex Groce}. 
  \newblock Donald Schön's \emph{The Reflective Practitioner: How Professionals Think in Action}. 
  \newblock Passages column, \emph{ACM SIGSOFT Software Engineering 
  Notes}, 51(2):6-7, April 2026.  
  
\item{\bf Alex Groce}. 
  \newblock Alan Schwarz's \emph{The Numbers Game: Baseball’s Lifelong Fascination with Statistics}. 
  \newblock Passages column, \emph{ACM SIGSOFT Software Engineering 
  Notes}, 51(1): 3-4, January 2026.  
  
\item {\bf Alex Groce}. 
  \newblock William Goldbloom Bloch's \emph{The Unimaginable Mathematics of Borges’ Library of Babel}. 
  \newblock Passages column, \emph{ACM SIGSOFT Software Engineering 
  Notes}, 50(3): 10-11, July 2025.
  
\item {\bf Alex Groce}. 
  \newblock Laurent Bossavit's \emph{The Leprechauns of Software Engineering: How Folklore Turns Into Fact and What to do About It}. 
  \newblock Passages column, \emph{ACM SIGSOFT Software Engineering 
  Notes}, 50(2): 9, April 2025.
  
\item {\bf Alex Groce}. 
  \newblock Peter Seibel's \emph{Coders at Work: Reflections on the Craft of Programming}. 
  \newblock Passages column, \emph{ACM SIGSOFT Software Engineering 
  Notes}, 49(4): 7, October 2024.

  
\item {\bf Alex Groce}.
  \newblock Richard W. Hamming's \emph{The Art of Doing Science and Engineering: Learning to Learn}.
  \newblock Passages column, \emph{ACM SIGSOFT Software Engineering 
  Notes}, 49(3): 13, July 2024.
...
\begin{Professional Activities and Service}
 \item Editorial Board, STVR (Software: Testing, Verification and
   Reliability), 
    July 2024-present.
...
\item Review Panelist for US National Science Foundation. 
...
\item Program committee $\cdot$ 49th ACM/IEEE International Conference
  on Software Engineering (ICSE'27), Dublin, Ireland, April-May 2027.
    \item Program committee $\cdot$ 49th ACM/IEEE International Conference on 
    Software Engineering 2027 (ICSE'27), Software Engineering In Practice Track, Dublin, Ireland, April-May 2027.
\item Program committee $\cdot$ 41st IEEE/ACM International Conference 
  on Automated Software Engineering (ASE'26), Munich, Germany, 
  October 2026.  
\item Program committee $\cdot$ ACM SIGSOFT International Symposium on Software Testing and Analysis (ISSTA'26), Oakland, California, July 2026.
  \item Program committee $\cdot$ 19th IEEE International Conference on Software Testing, Verification and Validation (ICST'26),
    Daejeon, South Korea, May 2026.
  \item Program committee $\cdot$ 48th ACM/IEEE International Conference on 
    Software Engineering 2026 (ICSE'26), Software Engineering In Practice Track, Rio de Janeiro, Brazil, April 2026  .
  \item Program committee $\cdot$ ACM International Conference on the Foundations of Software Engineering (FSE'25), Industry Track, Trondheim, Norway, June 2025.
  \item Program committee $\cdot$ 47th ACM/IEEE International Conference on 
    Software Engineering 2025 (ICSE'25), Software Engineering In Practice Track, Ottawa, Canada, April-May 2025.
  \item Program committee $\cdot$ 2030 Software Engineering, Porto de Galinhas, Brazil, co-located with ACM International Conference on the Foundations of Software Engineering (FSE) 2024.
  \item Program committee $\cdot$ 47th ACM/IEEE International Conference on 
...
\item Austin Sanders, Northern Arizona University, PhD, Committee
  Member
  \item Tung Nguyen, Northern Arizona University, PhD, Committee Member
...
\item Kush Jain, Carnegie Mellon University, PhD, External Committee Member  
